...
<%@ include file="/product/sub_menu.html" %>       
<script>
function go_order(pseq) {
	  document.formm.action = "/shopping_complete/action/order/insertImm?pseq="+pseq;
    ...
    <div id="itemdetail" >
      <form  method="post" name="formm">    
        <fieldset>
          ...
          <a href="${contextPath}/action/product/detail?pseq=${productVO.pseq}">         
        ...
        <div id="buttons">
          ...
          <input type="button" value="즉시 구매"       class="submit"    onclick="go_order(${productVO.pseq})"> 
