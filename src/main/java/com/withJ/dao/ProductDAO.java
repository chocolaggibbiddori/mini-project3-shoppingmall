...
public class ProductDAO {
	...
	public String pageNumber(int tpage, String name) {
		...
		if (start_page > view_rows) {
			str += "<a href='/shopping_complete/action/admin/product/list?tpage=1&key=" + name
					+ "'>&lt;&lt;</a>&nbsp;&nbsp;";
			str += "<a href='/shopping_complete/action/admin/product/list?tpage=" + (start_page - 1);
		...
		for (int i = start_page; i <= end_page; i++) {
			if (i == tpage) {
				...
				str += "<a href='/shopping_complete/action/admin/product/list?tpage=" + i + "&key=" + name + "'>[" + i
						+ "]</a>&nbsp;&nbsp;";
			}
		}

		if (page_count > end_page) {
			str += "<a href='/shopping_complete/action/admin/product/list?tpage=" + (end_page + 1) + "&key=" + name
					+ "'> &gt; </a>&nbsp;&nbsp;";
			str += "<a href='/shopping_complete/action/admin/product/list?tpage=" + page_count + "&key=" + name
					+ "'> &gt; &gt; </a>&nbsp;&nbsp;";
		}
		return str;
	}
